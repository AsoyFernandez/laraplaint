            ...
            <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <ul class="nav nav-tabs">
                          <li class="active"><a data-toggle="tab" href="#kategori">Kategori</a></li>
                ...
                <div id="import" class="tab-pane fade">
                    <form method="POST" action="{{ route('import.kategori') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('template.kategori') }}" class="btn btn-success btn-xs"><i class="fa fa-cloud-download"></i> Download</a>
                                @error('template')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
