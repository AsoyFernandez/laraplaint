        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div id="pengaduan" class="tab-pane fade in active">
                ...
                <div id="import" class="tab-pane fade">
                    <form method="POST" action="{{ route('import.pengaduan') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="form-group row">
                            <label for="template" class="col-md-offset-2 col-md-2 control-label col-form-label text-md-right">{{ __('Template') }}</label>

                            <div class="col-md-6">
                                <a href="{{ route('template.pengaduan') }}" class="btn btn-success btn-xs"><i class="fa fa-cloud-download"></i> Download</a>
                                @error('template')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
